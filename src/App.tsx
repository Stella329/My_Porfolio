        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <a
                href="mailto:stella33299@gmail.com"
            ...
            <div className="flex flex-col justify-end md:items-end gap-16">
              ...
              <div className="flex items-center gap-8">
                ...
                {/* LinkedIn Icon */}
                <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#D9A299] transition-colors">
